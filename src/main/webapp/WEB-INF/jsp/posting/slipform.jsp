...
<head>
  ...
  <script>
    $(document).ready(function () {
      ...
      $("#searchCode").keydown(function (key) {   //  #3
        if (key.code == 'Enter') {
          searchCode();
        }
      })
    ...
    function createPdf() {
      ...
      <%--window.open("${pageContext.request.contextPath}/base/report.html?method=FinancialPosition&slipNo=" + selectedSlipRow.slipNo); #7--%>
    ...
    function createSlip() {
      ...
      gridOptions = {
        ...
        stopEditingWhenCellsLoseFocus: true, // 그리드가 포커스를 잃으면 편집 중지
    ...
    function createJournal() {
      ...
      gridOptions2 = {
        ...
        detailCellRendererParams     : {
          detailGridOptions: {
            ...
            getRowId          : function (data) {
              ...
              console.log("getRowId: " + data.data.journalDetailNo);
              return data.data.journalDetailNo;
            },
        ...
        getRowId                 : function (data) {
          ...
          // use 'account' as the row ID
          console.log("getRowId: " + data.data.journalNo);
          return data.data.journalNo;
        },
      ...
      if (selectedSlipRow["slipNo"] !== NEW_SLIP_NO) {
        ...
        $.ajax({
          ...
          success : function (jsonObj) {
            ...
            console.log(jsonObj);
            console.log(gridOptions2);
            console.log(detailGridApi);
            console.log(gridOptions2.detailCellRendererParams.detailGridOptions);
            console.log("======================================================");
            let detailGrid=gridOptions2.api.getDetailGridInfo('detail_'+event.value);
    ...
    function searchAccount() {
      ...
      $.ajax({
        ...
        success : function (jsonObj) {
          console.log(jsonObj);
          gridOpionsAccountDetail.api.setRowData(jsonObj); //내부 상세 그리드
